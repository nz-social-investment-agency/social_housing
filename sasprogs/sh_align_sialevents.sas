...
%si_align_sialevents_to_periods(si_table_in=[IDI_Sandpit].[&si_proj_schema.].[&si_pop_table_out.], 
si_sial_table=[IDI_Sandpit].[&si_proj_schema.].[SIAL_ACC_injury_events], si_as_at_date =&si_as_at_date., 
si_amount_type= L, noofperiodsbefore=&si_num_periods_before., noofperiodsafter=&si_num_periods_after., 
period_duration= &si_period_duration., si_out_table=sand.ACC_injury_events, period_aligned_to_calendar = False);


/*MSD T1*/
%si_align_sialevents_to_periods(si_table_in=[IDI_Sandpit].[&si_proj_schema.].[&si_pop_table_out.], 
si_sial_table=[IDI_Sandpit].[&si_proj_schema.].[SIAL_MSD_T1_events], si_as_at_date =&si_as_at_date., 
si_amount_type= L, noofperiodsbefore=&si_num_periods_before., noofperiodsafter=&si_num_periods_after., 
period_duration= &si_period_duration., si_out_table=sand.MSD_T1_events, period_aligned_to_calendar = False);

/*MSD T2*/
%si_align_sialevents_to_periods(si_table_in=[IDI_Sandpit].[&si_proj_schema.].[&si_pop_table_out.], 
si_sial_table=[IDI_Sandpit].[&si_proj_schema.].[SIAL_MSD_T2_events], si_as_at_date =&si_as_at_date., 
si_amount_type= L, noofperiodsbefore=&si_num_periods_before., noofperiodsafter=&si_num_periods_after., 
period_duration= &si_period_duration., si_out_table=sand.MSD_T2_events, period_aligned_to_calendar = False);

/*MSD T3*/
%si_align_sialevents_to_periods(si_table_in=[IDI_Sandpit].[&si_proj_schema.].[&si_pop_table_out.], 
si_sial_table=[IDI_Sandpit].[&si_proj_schema.].[SIAL_MSD_T3_events], si_as_at_date =&si_as_at_date., 
si_amount_type= L, noofperiodsbefore=&si_num_periods_before., noofperiodsafter=&si_num_periods_after., 
...
/*CYF client */
%si_align_sialevents_to_periods(si_table_in=[IDI_Sandpit].[&si_proj_schema.].[&si_pop_table_out.], 
si_sial_table=[IDI_Sandpit].[&si_proj_schema.].[SIAL_CYF_client_events], si_as_at_date =&si_as_at_date., 
si_amount_type= L, noofperiodsbefore=&si_num_periods_before., noofperiodsafter=&si_num_periods_after., 
period_duration= &si_period_duration., si_out_table=sand.CYF_client_events, period_aligned_to_calendar = False);

/*CYF abuse */
%si_align_sialevents_to_periods(si_table_in=[IDI_Sandpit].[&si_proj_schema.].[&si_pop_table_out.], 
si_sial_table=[IDI_Sandpit].[&si_proj_schema.].[SIAL_CYF_abuse_events], si_as_at_date =&si_as_at_date., 
si_amount_type= L, noofperiodsbefore=&si_num_periods_before., noofperiodsafter=&si_num_periods_after., 
...
/*MOH pharm */
%si_align_sialevents_to_periods(si_table_in=[IDI_Sandpit].[&si_proj_schema.].[&si_pop_table_out.], 
si_sial_table=[IDI_Sandpit].[&si_proj_schema.].[SIAL_MOH_pharm_events], si_as_at_date =&si_as_at_date., 
si_amount_type= L, noofperiodsbefore=&si_num_periods_before., noofperiodsafter=&si_num_periods_after., 
...
/*MOJ courtcase */
%si_align_sialevents_to_periods(si_table_in=[IDI_Sandpit].[&si_proj_schema.].[&si_pop_table_out.], 
si_sial_table=[IDI_Sandpit].[&si_proj_schema.].[SIAL_MOJ_courtcase_events], si_as_at_date =&si_as_at_date., 
si_amount_type= L, noofperiodsbefore=&si_num_periods_before., noofperiodsafter=&si_num_periods_after., 
...
/*COR sentences */
%si_align_sialevents_to_periods(si_table_in=[IDI_Sandpit].[&si_proj_schema.].[&si_pop_table_out.], 
si_sial_table=[IDI_Sandpit].[&si_proj_schema.].[SIAL_COR_sentence_events], si_as_at_date =&si_as_at_date., 
si_amount_type= L, noofperiodsbefore=&si_num_periods_before., noofperiodsafter=&si_num_periods_after., 
...
/*MOE ECE */
%si_align_sialevents_to_periods(si_table_in=[IDI_Sandpit].[&si_proj_schema.].[&si_pop_table_out.], 
si_sial_table=[IDI_Sandpit].[&si_proj_schema.].[SIAL_MOE_ECE_events], si_as_at_date =&si_as_at_date., 
si_amount_type= L, noofperiodsbefore=&si_num_periods_before., noofperiodsafter=&si_num_periods_after., 
...
%si_align_sialevents_to_periods(si_table_in=[IDI_Sandpit].[&si_proj_schema.].[&si_pop_table_out.], 
si_sial_table=[IDI_Sandpit].[&si_proj_schema.].[SIAL_MOE_intervention_events], si_as_at_date =&si_as_at_date., 
si_amount_type= L, noofperiodsbefore=&si_num_periods_before., noofperiodsafter=&si_num_periods_after., 
period_duration= &si_period_duration., si_out_table=sand.MOE_intervention_events, period_aligned_to_calendar = False);

/*MOE ITL */
%si_align_sialevents_to_periods(si_table_in=[IDI_Sandpit].[&si_proj_schema.].[&si_pop_table_out.], 
si_sial_table=[IDI_Sandpit].[&si_proj_schema.].[SIAL_MOE_ITL_events], si_as_at_date =&si_as_at_date., 
si_amount_type= L, noofperiodsbefore=&si_num_periods_before., noofperiodsafter=&si_num_periods_after., 
period_duration= &si_period_duration., si_out_table=sand.MOE_ITL_events, period_aligned_to_calendar = False);

/*MOE school */
%si_align_sialevents_to_periods(si_table_in=[IDI_Sandpit].[&si_proj_schema.].[&si_pop_table_out.], 
si_sial_table=[IDI_Sandpit].[&si_proj_schema.].[SIAL_MOE_school_events], si_as_at_date =&si_as_at_date., 
si_amount_type= L, noofperiodsbefore=&si_num_periods_before., noofperiodsafter=&si_num_periods_after., 
period_duration= &si_period_duration., si_out_table=sand.MOE_school_events, period_aligned_to_calendar = False);

/*MOE tertiary */
%si_align_sialevents_to_periods(si_table_in=[IDI_Sandpit].[&si_proj_schema.].[&si_pop_table_out.], 
si_sial_table=[IDI_Sandpit].[&si_proj_schema.].[SIAL_MOE_tertiary_events], si_as_at_date =&si_as_at_date., 
si_amount_type= L, noofperiodsbefore=&si_num_periods_before., noofperiodsafter=&si_num_periods_after., 
...
/*IRD cost */
%si_align_sialevents_to_periods(si_table_in=[IDI_Sandpit].[&si_proj_schema.].[&si_pop_table_out.], 
si_sial_table=[IDI_Sandpit].[&si_proj_schema.].[SIAL_IRD_income_events], si_as_at_date =&si_as_at_date., 
si_amount_type= L, noofperiodsbefore=&si_num_periods_before., noofperiodsafter=&si_num_periods_after., 
...
/*POL offender */
%si_align_sialevents_to_periods(si_table_in=[IDI_Sandpit].[&si_proj_schema.].[&si_pop_table_out.], 
si_sial_table=[IDI_Sandpit].[&si_proj_schema.].[SIAL_POL_offender_events], si_as_at_date =&si_as_at_date., 
si_amount_type= L, noofperiodsbefore=&si_num_periods_before., noofperiodsafter=&si_num_periods_after., 
period_duration= &si_period_duration., si_out_table=sand.POL_offender_events, period_aligned_to_calendar = False);

/*POL victim */
%si_align_sialevents_to_periods(si_table_in=[IDI_Sandpit].[&si_proj_schema.].[&si_pop_table_out.], 
si_sial_table=[IDI_Sandpit].[&si_proj_schema.].[SIAL_POL_victim_events], si_as_at_date =&si_as_at_date., 
si_amount_type= L, noofperiodsbefore=&si_num_periods_before., noofperiodsafter=&si_num_periods_after., 
